...
export type mjtIntegrator = mjtIntegratorValue<0>|mjtIntegratorValue<1>|mjtIntegratorValue<2>|mjtIntegratorValue<3>|mjtIntegratorValue<4>;
...
export interface MjData extends ClassHandle {
  ...
  readonly efm_L: any;
  efm_active: number;
  readonly efm_aid: any;
  readonly efm_ak: any;
  readonly efm_as: any;
  readonly efm_c: any;
  readonly efm_ca: any;
  readonly efm_ck: any;
  readonly efm_con_ind: any;
  readonly efm_con_val: any;
  readonly efm_diag: any;
  readonly efm_dofid: any;
  readonly efm_fluid: any;
  readonly efm_sdiag: any;
  readonly efm_tid: any;
  readonly efm_tk: any;
  readonly efm_ts: any;
  readonly energy: any;
...
interface EmbindModule {
  ...
  mjtIntegrator: {mjINT_EULER: mjtIntegratorValue<0>, mjINT_RK4: mjtIntegratorValue<1>, mjINT_IMPLICIT: mjtIntegratorValue<2>, mjINT_IMPLICITFAST: mjtIntegratorValue<3>, mjINT_DISCRETE: mjtIntegratorValue<4>};
  ...
  mj_insideSite(_0: MjModel, _1: MjData, _2: number, _3: number[]): number;
